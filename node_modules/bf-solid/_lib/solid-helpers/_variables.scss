...
// Controls whether or not we use font sizing.
// See the font-smoothing mixin in _mixins.scss
$font-smoothing: true !default;

// Fonts
// -------------------------

$sans: "Proxima Nova", Helvetica, Arial, sans-serif !default;
$slab: "Caponi-Slab-Semibold", "Proxima Nova", Helvetica, Arial, sans-serif !default;
...
$fill-blue:            #0f65ef !default;
$fill-purple:          #6645dd !default;
$fill-yellow:          #ffee00 !default;
$fill-yellow-lighter:  #fffab6 !default;
$fill-teal:            #0dccb0 !default;
$fill-green:           #68af15 !default;
$fill-green-lighter:   #e1efd0 !default;
$fill-orange:          #f47f16 !default;
$fill-promoted-orange: #f7ad19 !default;
$fill-gray-lighter:    #f4f4f4 !default;
$fill-gray:            #aaa    !default;
$fill-gray-darker:     #222    !default;
...
$text-gray:            #222    !default;
$text-gray-lighter:    #666    !default;
$text-gray-lightest:   #999    !default;
$text-red:             #e32    !default;
$text-pink:            #f43192 !default;
$text-orange:          #f47f16 !default;
$text-promoted-orange: #f7ad19 !default;
$text-purple:          #6645dd !default;
$text-green:           #68af15 !default;
$text-blue:            #0f65ef !default;

// Social Type Colors
$text-facebook:  #3b5998 !default;
$text-twitter:   #55acee !default;
$text-google:    #dd4b39 !default;
$text-linkedin:  #0077b5 !default;
...
// Line height
// -------------------------
// Using a unitless system for consistency.
// https://css-tricks.com/almanac/properties/l/line-height/

$line-height-1: 1.2 !default; // set on h1-h3 and .text-1-.text-3
$line-height-2: 1.3 !default; // set on h4-h6 and .text-4-.text-6
$line-height-3: 1.5 !default; // default line-height set on the body

// Line heights specific to forms, buttons and tags.
$line-height-form:       1.5rem  !default;
$line-height-form-small: 1.25rem !default;
